...
namespace Producer_Consumer_Dataflow_Pattern
{

    class DataflowProducerConsumer
    {
        private object producedLocker = new object();
    ...
    class Program
    {
        ...
        {
            DataflowProducerConsumer dataflowProducerConsumer = new DataflowProducerConsumer();
